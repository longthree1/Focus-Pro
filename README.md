...
[![Version](https://img.shields.io/badge/version-1.6.0-blue)](https://github.com/longthree1/Focus-Pro)
...
- **Khóa âm thanh (Audio Lock)** — không bị Facebook tự động tắt tiếng (chạy ngầm)
- **Menu Tốc độ phát (Speed Menu)** — chỉnh tốc độ cực mượt từ 0.5x đến 2x
